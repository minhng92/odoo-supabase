...
Deploy to `odoo-supabase` with Odoo at `localhost:10019`, live chat at `localhost:20019`, and Supabase Studio at `localhost:8000`. Default credentials:
- Odoo:
    - Email: admin
    - Password: admin
    - Master Password (DB): minhng.info
- Supabase Studio:
    - Username: supabase
